...
date: 2017-08-21
excerpt: "In this post, I present a new method to estimate lake ice thickness and its changes in Lake Huron, using collocated GPS-R and tide gauge data sets."
mathjax: "true"
---
...
## 1.Introduction
  ...
  <img src="{{ site.url }}{{ site.baseurl }}/images/gpsr-lakeice/1_1.png" alt="linearly separable data">
...
## 2.Station Installation
  ...
  <img src="{{ site.url }}{{ site.baseurl }}/images/gpsr-lakeice/2_1.png" alt="linearly separable data">
